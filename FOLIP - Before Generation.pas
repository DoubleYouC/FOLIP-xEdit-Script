...
begin
    ...
    joElements.O['references'].O['New'].O[wrldEdid].O[cellX].O[cellY].O[recordId].S['Initially Disabled'] := True;
    joElements.O['references'].O['New'].O[wrldEdid].O[cellX].O[cellY].O[recordId].S['Opposite Enable Parent'] := 0;
